...
export const defaultValueCast = new Cast(0, '', '', '', '');
export const defaultValueDetailsTV = new DetailTV('', [], '', '', [], [], { air_date: '', episode_number: 0, id: 0, name: '', ocerview: '', season_number: 0, still_path: '', vote_average: 0 }, '', [], 0, 0, '', '', '', '', [], [], 0, 0, '', [{ id: 0, name: '' }], '');
